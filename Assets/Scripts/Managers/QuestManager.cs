...
public class QuestManager : MonoBehaviour
{
    ...
    public List<Quest> GetQuestsForEra(Era era)
    {
        ...
        if (era.eraName.Contains("Primitive"))
        {
            ...
            new QuestAnswer("Weapons and defense", "STR +1"), // Сила для защиты
            new QuestAnswer("Rituals and community bonding", "REL +1") // Социальные навыки для общества
                }
            ));
            ...
            quests.Add(new Quest(
                ...
                new List<QuestAnswer>
                {
            new QuestAnswer("Avoid conflicts", "STR -1"),
            new QuestAnswer("Prepare for war", "AGI -1"),
        ...
        else if (era.eraName.Contains("Ancient"))
        {
            ...
            new QuestAnswer("For historical record-keeping", "SCI +1") // Обучаемость через хранение знаний
                }
            ));
            ...
            quests.Add(new Quest(
                ...
                new List<QuestAnswer>
                {
            new QuestAnswer("Build the pyramid to honor the leader", "CUL +1"), // Культура через памятники
        ...
        else if (era.eraName.Contains("Antiquity"))
        {
            ...
            new QuestAnswer("Use it for scientific research", "SCI +1"), 
        ...
        new QuestAnswer("Oppose democracy to preserve stability", "STR +1") // Эмоциональная стабильность
                }
            ));
        ...
        new QuestAnswer("Create memes and +18 content", "SCI -5"),
        ...
        new QuestAnswer("Improve sustainability on Earth before venturing into space", "LOG +1") // Культура
                }
            ));
